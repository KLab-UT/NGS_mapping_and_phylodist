...
cd $i
# example file in mapped reads RLK004_USD16091389L_HJNHCDSXX_L3.unmerged_sorted.bam
...
samtools merge KLC098_${g}_merged.bam KLC098_*_L4.merged_sorted.bam KLC098_*_L1.merged_sorted.bam
samtools merge RLK019_${g}_merged.bam RLK019_*_L3.merged_sorted.bam RLK019_*_L1.merged_sorted.bam

#merge (unmerged.bam) files that were sequenced across multiple lanes
samtools merge KLC098_${g}_unmerged.bam KLC098_*_L4.unmerged_sorted.bam KLC098_*_L1.unmerged_sorted.bam

samtools merge RLK019_${g}_unmerged.bam RLK019_*_L3.unmerged_sorted.bam RLK019_*_L1.unmerged_sorted.bam

#change names of (merged_sorted.bam) and (unmerged_sorted.bam) files sequenced on a single lane
# RLK004 and RLK034
cp RLK004*.merged_sorted.bam RLK004_${g}_merged.bam
cp RLK034*.merged_sorted.bam RLK034_${g}_merged.bam

cp RLK004*.unmerged_sorted.bam RLK004_${g}_unmerged.bam
cp RLK034*.unmerged_sorted.bam RLK034_${g}_unmerged.bam
