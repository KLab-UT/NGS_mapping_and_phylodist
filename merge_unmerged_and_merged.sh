...
[[ ! -f "KLC098_${g}.bam" ]] && samtools merge KLC098_${g}.bam KLC098_*_merged.bam KLC098_*_unmerged.bam

[[ ! -f "RLK019_${g}.bam" ]] && samtools merge RLK019_${g}.bam RLK019_*_merged.bam RLK019_*_unmerged.bam

[[ ! -f "RLK004_${g}.bam" ]] && samtools merge RLK004_${g}.bam RLK004_*_merged.bam RLK004_*_unmerged.bam

[[ ! -f "RLK034_${g}.bam" ]] && samtools merge RLK034_${g}.bam KLC098_*_merged.bam RLK034_*_unmerged.bam
